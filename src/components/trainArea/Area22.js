            ...
            <View style={{ flex: 1 }}>
                ...
                <ScrollView showsVerticalScrollIndicator={true} style={{ paddingHorizontal: 27 * SCALE, paddingVertical: 15 * SCALE, flex: 1 }}>
                    ...
                    <View style={{
                        ...
                        <View style={{ height: 44 * SCALE, marginBottom: 21 * SCALE }}>
                            <TouchableOpacity
                        ...
                        </View>
                        {
                            question.prompt || question.text ? (
                                <View style={{ flexDirection: 'row' }}>
                                    <Text style={{ fontSize: 16 * SCALE, backgroundColor: '#f5f5f5', paddingHorizontal: 11 * SCALE, marginBottom: 21 * SCALE, borderRadius: 2 * SCALE, height: 36 * SCALE, lineHeight: 36 * SCALE }}>{question.prompt || question.text}</Text>
                                </View>
                            ) : null
                        }
                        {contents}
